<?php
    ...
    <tbody>
        <tr class="content"><td style="font-weight: bold;">Weather</td> <td>' . $resp['weather']['weather'][0]['main'] . ' (' . $resp['weather']['clouds']['all'] . '%) <small>' . $resp['weather']['weather'][0]['description'] . '</small></td></tr>
